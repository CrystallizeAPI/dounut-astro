...
cp ${PROJECT_PATH}/provisioning/clone/.env.dist ${PROJECT_PATH}/.env.dist
cp ${PROJECT_PATH}/provisioning/clone/robots.txt ${PROJECT_PATH}/public/robots.txt

#---

echo "Running command ${PROJECT_PATH}"
cd ${PROJECT_PATH} && cp .env.dist .env
